...
export default function TrainInfo({
  ...
  return (
    <Link
      className={`flex min-h-40 w-[90vw] max-w-[700px] cursor-pointer flex-col gap-2 rounded-lg border-2 p-2 transition-all ${cancelled ? 'border-red-700 bg-red-50' : 'border-gray-300 bg-white hover:bg-gray-100'}`}
